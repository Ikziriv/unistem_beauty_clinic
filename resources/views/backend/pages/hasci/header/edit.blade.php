            ...
            <div class="card text-center">
              <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                  <li class="nav-item">
                    <a class="nav-link active" href="{{route('hasci-header')}}">Back</a>
                  </li>
                </ul>
              </div>
              ...
              <div class="card-block">
                <div class="card text-left" style="width: 100%; border-style: none;">
                  <div class="card-body">
                    <form class="form-horizontal" action="{{route('hasci-header-update', $hasci_header->id)}}" method="POST"  enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <fieldset>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-12 no-padding">
                          <input id="title" name="title" type="text" class="form-control" value="{{$hasci_header->title}}">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-12 control-label no-padding" for="content">Content</label>
                        <div class="col-12 no-padding">
                          <textarea class="form-control" id="content" name="content">{{$hasci_header->content}}</textarea>
                        </div>
                      </div>
                      <div class="form-group">
