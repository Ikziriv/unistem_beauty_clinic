                  ...
                  <div class="card-body">
                    ...
                    <fieldset>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-12 no-padding">
                          <input id="name" name="name" type="text" value="{{$appointment->name}}" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-12 control-label no-padding" for="name">Email</label>
                        <div class="col-12 no-padding">
                          <input id="email" name="email" type="text" value="{{$appointment->email}}" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-12 control-label no-padding" for="name">Date</label>
                        <div class="col-12 no-padding">
                          <input id="scheduled_time" name="scheduled_time" type="text" value="{{$appointment->date}}" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-12 control-label no-padding" for="message">Message</label>
                        <div class="col-12 no-padding">
                          <textarea id="message" name="message" type="text" class="form-control">{{{{$appointment->message}}}}</textarea>
                        </div>
                      </div>
                      <div class="form-group">
