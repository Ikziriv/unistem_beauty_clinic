            ...
            <div class="card text-center">
              <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                  <li class="nav-item">
                    <a class="nav-link active" href="{{route('doctor')}}">Back</a>
                  </li>
                </ul>
              </div>
                    ...
                    <fieldset>
                      <div class="form-group">
                        ...
                        <div class="col-12 no-padding">
                          <input id="title" name="title" type="text" value="{{$doctor->title}}" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-12 control-label no-padding" for="img_head">Image</label>
                        <div class="col-12 no-padding">
                          <input id="img_head" name="img_head" value="{{$doctor->img_head}}" type="file" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-12 control-label no-padding" for="content">Content</label>
                        <div class="col-12 no-padding">
                          <textarea class="form-control" id="content" name="content" rows="5">{{$doctor->content}}</textarea>
                        </div>
                      </div>
                      <div class="form-group">
