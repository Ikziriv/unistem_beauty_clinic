            ...
            <div class="card text-center">
              <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                  <li class="nav-item">
                    <a class="nav-link active" href="{{route('contact')}}">Back</a>
                  </li>
                </ul>
              </div>
                    ...
                    <fieldset>
                      <div class="form-group">
                        ...
                        <div class="col-12 no-padding">
                          <input id="title" name="title" type="text" value="{{$contact->title}}" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-12 control-label no-padding" for="content">Content</label>
                        <div class="col-12 no-padding">
                          <textarea class="form-control" id="content" name="content" rows="5">{{$contact->content}}</textarea>
                        </div>
                      </div>
                      <div class="form-group">
