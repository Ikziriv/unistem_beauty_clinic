                  ...
                  <div class="card-body">
                    ...
                    <fieldset>
                      <div class="form-group">
                        <label class="col-12 control-label no-padding" for="img_head">Image Head</label>
                        <div class="col-12 no-padding">
                          <input id="img_head" name="img_head" type="file" class="form-control file-input">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-12 control-label no-padding" for="title">Title</label>
                        <div class="col-12 no-padding">
                          <input id="title" name="title" type="text" value="{{$about->title}}" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
