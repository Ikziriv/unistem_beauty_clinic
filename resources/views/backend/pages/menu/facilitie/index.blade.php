            ...
            <div class="card text-center">
              <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                  <li class="nav-item">
                    <a class="nav-link active" href="{{route('facilitie-create')}}">Upload</a>
                  </li>
                </ul>
              </div>
                    ...
                    <div class="col-12">
                      <form class="form-inline justify-content-end">
                        <div class="form-group mb-2">
                          <input type="date" id="search_facilitie" name="search_facilitie" class="form-control w-100">
                        </div>
                    ...
                    <div class="card">
                      <div class="card-header">
                          ...
                          <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                              <form id="delete-form-{{$value['id']}}" 
                                  method="post" 
                                  action="{{route('facilitie-delete', $value['id'])}}"
                                  style="display: none;">
                                {{csrf_field()}}
                                {{method_field('DELETE')}}
                              </form>
                        ...
                        <div class="card-block" style="width: 100%;">
                          <img class="img-thumbnail img-responsive" src="{{asset('storage/'. $value['path_img'] .'')}}">
                          <small class="text-center">{{$value['date']}}</small>
                        </div>
                    </div>
                    </div>
                    @empty
