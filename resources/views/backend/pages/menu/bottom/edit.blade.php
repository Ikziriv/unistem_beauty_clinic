            ...
            <div class="card text-center">
              <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                  <li class="nav-item">
                    <a class="nav-link active" href="{{route('bottom')}}">Back</a>
                  </li>
                </ul>
              </div>
              ...
              <div class="card-block">
                <div class="card text-left" style="width: 100%; border-style: none;">
                  <div class="card-body">
                    <form class="form-horizontal" action="{{route('bottom-update', $bottom->id)}}" method="POST">
                    {{ csrf_field() }}
                    <fieldset>
                      <div class="form-group">
                        <label class="col-12 control-label no-padding" for="address">Address</label>
                        <div class="col-12 no-padding">
                          <textarea class="form-control" id="content" name="address" rows="5">{{trim($bottom->address)}}</textarea>
                        </div>
                      </div>
                      <div class="form-group">
