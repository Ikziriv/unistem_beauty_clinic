            ...
            <div class="card text-center">
              ...
              <div class="card-block">
                <div class="card text-left" style="width: 100%; border-style: none;">
                  <div class="card-body">
                    <form class="form-horizontal" action="{{route('open_hour-update', $open_hour->id)}}" method="POST">
                    {{ csrf_field() }}
                    <fieldset>
                      <div class="form-group">
                        <label class="col-12 control-label no-padding" for="days">Days</label>
                        <div class="col-12 no-padding">
                          <input id="days" name="days" type="text" value="{{$open_hour->days}}" value="" class="form-control">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-12 no-padding">
                          <input id="time" name="time" type="text" value="{{$open_hour->time}}" value="" class="form-control">
