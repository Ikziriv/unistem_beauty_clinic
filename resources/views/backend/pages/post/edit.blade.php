                  ...
                  <div class="card-body">
                    ...
                    <fieldset>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-12 no-padding">
                          <input id="sub_title" name="sub_title" type="text" value="{{$post->sub_title}}" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-12 no-padding">
                          <input id="img_path" name="img_path" value="{{$post->img_path}}" type="file" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
